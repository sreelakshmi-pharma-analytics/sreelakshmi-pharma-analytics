# Pharma Analytics Portfolio - Sreelakshmi

Welcome to my analytics portfolio focused on pharmaceutical quality control and laboratory digital transformation and data integrity.
...
### 1 Pharmaceutical QC Analytics – Root Cause Analysis of OOS Trends
 ![OOS Dashboard](https://github.com/sreelakshmi-pharma-analytics/Pharma-QC-Analytics-Dashboard.git/Pharma_QC_OOS_Analytics_Dashboard_preview.png.png)
...
An Excel analytics dashboard analyzing Out-of-Specification (OOS) trends to identify root causes across analytical parameters, products, and analysts.
 ...
 [View Full Project Repository](https://github.com/sreelakshmi-pharma-analytics/Pharma-QC-Analytics-Dashboard.git)
...
These projects demonstrate practical applications of data analytics in pharmaceutical Quality Control environments, supporting quality investigation, regulatory compliance, and digital transformation initiatives.
